          ...
          <div class="flex items-center gap-2 pt-0.5">
            ...
            {#if connInfo?.mode === "remote"}
              <button
                type="button"
                disabled={connBusy}
                class="inline-flex h-7 items-center rounded-md border border-border bg-secondary px-2.5 text-xs font-medium text-muted-foreground transition-colors hover:bg-secondary/80 disabled:opacity-50"
  ...
  <div class="flex items-center gap-2">
        ...
        {#if updateOpen}
          ...
          >
            ...
            <div class="flex items-center gap-2">
              ...
              <button
                type="button"
                class="inline-flex h-7 items-center rounded-md border border-border bg-secondary px-2.5 text-xs font-medium text-muted-foreground transition-colors hover:bg-secondary/80"
    ...
    {#if version}
      <a
        ...
        class="micro-label [font-family:var(--font-sans)] text-muted-foreground hover:text-foreground flex items-center gap-0.5 transition-colors"
