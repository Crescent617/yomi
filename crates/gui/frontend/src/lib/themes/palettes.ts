...
export const DEFAULT_THEME_ID = "yomi-ink";
...
export const BUILTIN_THEMES: ColorTheme[] = [
  {
    ...
    name: "Kakishibu",
    builtin: true,
    // Yomi's signature theme: warm washi paper / sumi ink neutrals with a
    // persimmon (kakishibu) accent instead of the usual dev-tool blue.
    light: {
      background: "#f7f4ec",
      foreground: "#252219",
      card: "#efebdf",
      "card-foreground": "#252219",
      popover: "#e9e4d6",
      "popover-foreground": "#252219",
      primary: "#b85c1e",
      "primary-foreground": "#f7f4ec",
      secondary: "#e9e4d6",
      "secondary-foreground": "#252219",
      muted: "#e9e4d6",
      "muted-foreground": "#a19a8a",
      accent: "#e0d9c7",
      "accent-foreground": "#252219",
      destructive: "#a62b40",
      ...
      "code-bg": "#ebe6d8",
      success: "#5f7a3d",
      "success-foreground": "#f7f4ec",
      warning: "#9a6b10",
      "warning-foreground": "#f7f4ec",
      error: "#a62b40",
      "error-foreground": "#f7f4ec",
      info: "#3e5a9e",
      "info-foreground": "#f7f4ec",
    },
    dark: {
      background: "#1b1a17",
      foreground: "#e4dfd0",
      card: "#232220",
      "card-foreground": "#e4dfd0",
      popover: "#272624",
      "popover-foreground": "#e4dfd0",
      primary: "#e08e4d",
      "primary-foreground": "#1b1a17",
      secondary: "#272624",
      "secondary-foreground": "#e4dfd0",
      muted: "#272624",
      "muted-foreground": "#76705f",
      accent: "#302e2a",
      "accent-foreground": "#e4dfd0",
      destructive: "#d0617a",
      "destructive-foreground": "#1b1a17",
      border: "#3c3a34",
      input: "#3c3a34",
      ring: "#a06a3f",
      "code-bg": "#262522",
      success: "#a3b87e",
      "success-foreground": "#1b1a17",
      warning: "#d2a94e",
      "warning-foreground": "#1b1a17",
      error: "#d0617a",
      "error-foreground": "#1b1a17",
      info: "#8ea6da",
      "info-foreground": "#1b1a17",
    },
  },
  {
    id: "yomi-ai",
    name: "Aizome",
    builtin: true,
    // Kakishibu neutrals with a true-indigo (ai-iro) accent: the classic
    // indigo-dye-on-washi combination, cooler than the persimmon default.
    light: {
      background: "#f7f4ec",
      foreground: "#252219",
      card: "#efebdf",
