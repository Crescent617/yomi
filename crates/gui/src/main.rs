...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::chat::mailbox_snapshot,
            commands::chat::remove_mailbox_item,
            commands::chat::steer_mailbox_item,
            commands::chat::subscribe,
            commands::chat::unsubscribe,
            commands::chat::get_messages,
            commands::chat::get_session,
            commands::chat::get_session_rules,
            ...
            commands::agent_template::list_agent_templates,
            commands::agent_template::save_agent_template,
            commands::agent_template::delete_agent_template,
            ...
            commands::system::read_attachment_text,
